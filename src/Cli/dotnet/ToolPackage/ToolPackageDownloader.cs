            ...
            )
        {
            ...
            return TransactionalAction.Run<IToolPackage>(
                action: () =>
                {
                    ...
                    var nugetPackageDownloader = new NuGetPackageDownloader.NuGetPackageDownloader(toolDownloadDir, verboseLogger: nugetLogger, verifySignatures: true, isNuGetTool: true);
